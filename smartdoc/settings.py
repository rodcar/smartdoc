...
SECRET_KEY = 'django-insecure-f-u3x*$5qovut5)*lg!q#=wc7kvz$lu)4mn*jh&9g2@l3&jwa%'
...
# Provider Settings
OCR_PROVIDER = os.getenv('OCR_PROVIDER', 'default')
LLM_PROVIDER = os.getenv('LLM_PROVIDER', 'default') 
VECTORDB_PROVIDER = os.getenv('VECTORDB_PROVIDER', 'default')
TEXT_EMBEDDING_PROVIDER = os.getenv('TEXT_EMBEDDING_PROVIDER', 'default')
IMAGE_EMBEDDING_PROVIDER = os.getenv('IMAGE_EMBEDDING_PROVIDER', 'default')
